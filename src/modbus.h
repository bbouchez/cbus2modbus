...
// libmodbus as been updated on Linux targets but te compiled library on Windows
// still uses an older version of the structure
// The #define is not pretty at all, but at least it worlks for now...
